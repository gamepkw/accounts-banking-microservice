...
func NewMysqlAccountRepository(conn *sql.DB, redis *redis.Client) model.AccountRepository {
...
func (m *mysqlAccountRepository) getAllAccount(ctx context.Context, query string, args ...interface{}) (accounts []model.Account, err error) {
...
func (m *mysqlAccountRepository) GetAllAccount(ctx context.Context, cursor string, num int64) (res []model.Account, nextCursor string, err error) {
...
func (m *mysqlAccountRepository) GetAccountByAccountNo(ctx context.Context, account_no string) (res *model.Account, err error) {
...
func (m *mysqlAccountRepository) GetAllAccountByUuid(ctx context.Context, uuid string) (res *[]model.Account, err error) {
...
func (m *mysqlAccountRepository) GetAccountFromRedisByAccountNo(ctx context.Context, account_no string) (*model.Account, error) {
...
func (m *mysqlAccountRepository) fetchAllAccountFromDatabaseByUuid(ctx context.Context, uuid string) (accounts []model.Account, err error) {
...
func (m *mysqlAccountRepository) fetchAccountFromDatabase(ctx context.Context, account_no string) (res model.Account, err error) {
...
func (m *mysqlAccountRepository) parseAccountFromCache(cachedContact string) (*model.Account, error) {
...
func (m *mysqlAccountRepository) serializeAccount(account *model.Account) string {
	jsonData, _ := json.Marshal(account)
	return string(jsonData)
}

func (m *mysqlAccountRepository) RegisterAccount(ctx context.Context, a *model.Account) (err error) {
...
func (m *mysqlAccountRepository) UpdateAccount(ctx context.Context, ar *model.Account) (err error) {
